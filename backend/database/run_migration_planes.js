...
const migrationPath = path.join(__dirname, 'migration_planes_demandas.sql');
...
console.log('🔄 Ejecutando migración de planes y demandas...');
    ...
    if (completed === statements.length) {
      db.close((err) => {
        ...
        if (errors === 0) {
          ...
          console.log('👤 Usuario auxiliar creado:');
